...
// import { setPlaylist } from "../state/audioSlice";
// import {
//   setupAudioListeners,
//   handleNextSong,
// } from "../state/actionCreator/index";
...
//   useEffect(() => {
//     dispatch(setPlaylist(songs)); // Store the playlist when the component mounts
//   }, [dispatch]);
...
//       if (audioElement) {
//         // Pause the current audio and reset its source
//         audioElement.pause();
//         audioElement.currentTime = 0;
//         audioElement.src = "";
  
//         // Wait a bit before setting the new src to avoid race conditions
//         setTimeout(() => {
//           audioElement.src = data.file_path;
  
//           // Ensure audio only plays when it's ready
...
//           // Load the new song
//           audioElement.load();
//         }, 200); // Small delay to ensure previous song cleanup
//       }
//     } catch (error) {
...
//         audioElement.play();
//       } else {
//         dispatch(handleNextSong()); // ✅ Ensures next song plays
//       }
//     };
...
//     };
//   }, [currentSong, isLoading, repeat, dispatch, audioElement]);
  

//   useEffect(() => {
//     dispatch(setupAudioListeners()); // ✅ This ensures that "onended" correctly plays next song
